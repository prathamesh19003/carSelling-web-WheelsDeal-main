  ...
  return (
    <div className="container pt-24">
      ...
      <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-10 gap-5">
        <ServiceCards icon={icon1} title="BUY & SELL CARS" />
        <ServiceCards icon={icon2} title="PRICE PREDICTION" />
        <ServiceCards icon={icon3} title="CAR INSPECTION" />
        <ServiceCards icon={icon4} title="COMPELTE CONVINIENCE" />
        <ServiceCards icon={icon5} title="FASTER PROCESSING" />
        <ServiceCards icon={icon6} title="BOOK A TEST RIDE" />
      </div>
    </div>
  );
};
